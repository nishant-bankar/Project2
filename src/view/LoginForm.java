...
//	public JFrame ourFrame = new JFrame("Subscribe");
	...
	public static void signUpForm(JFrame ourFrame) {
		...
		subBtn.setBounds(100, 130, 100, 30);
		subBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (textfield_1.getText().equals("") || textfield_2.getText().equals("")) {
					...
					try {
						int result=dao.checkLogin(textfield_1.getText(), textfield_2.getText());
					...
					if(result==1) {
						...
						if(textfield_1.getText().equals("admin") && textfield_2.getText().equals("sort8f")) {
							Application.panel_35.setVisible(true);
						}else {
							Application.panel_35.setVisible(false);
						}
					}else {
		...
		adduser.setBounds(210, 130, 100, 30);
		adduser.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Registation.registrationForm(frm);
