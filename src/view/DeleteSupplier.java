		...
		subBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (textfield_1.getText().equals("") || textfield_2.getText().equals("")) {
					...
					if(result==1) {
			   		try {
			   			//System.out.println("Query parameter :"+Application.batchname+"      "+Application.componentName);
						int result1=0;	 
						result1= UserDAO.deleteSupplier(FetchParameter.dbatchname, FetchParameter.componentName);
